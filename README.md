...
* OTP delivery: Console log (mock)
* No database or external SMS service
...
OTP delivery is mocked via backend console logging, as permitted in the challenge.
This demonstrates the full authentication lifecycle without external services.
